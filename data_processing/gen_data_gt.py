...
def Parser(add_help=True):
    parser = argparse.ArgumentParser(description='Process some integers.', formatter_class = argparse.ArgumentDefaultsHelpFormatter,
                                     add_help=add_help)
    parser.add_argument('--scans', type=str,default='/data/caidaigang/project/3DSSG_Repo/data/3RScan')
    ...
    parser.add_argument('--pth_out', type=str, default='../data/3DSSG_Sub_Split_KNN', help='pth to output directory',required=False)
    ...
    parser.add_argument('--search_method', type=str, choices=['BBOX','KNN'],default='KNN',help='How to split the scene.')
    ...
    parser.add_argument('--split_method', type=str, choices=['BBOX','KNN'],default='KNN',help='How to split the scene.')
...
def gen_relationship(scan_id:str,split:int, map_segment_pd_2_gt:dict,instance2labelName:dict,
    ...
    if gt_relationships is not None:
        ...
        for rel in gt_relationships:
            ...
            if int(id_src) in objects.keys() and int(id_tar) in objects.keys():
...
if __name__ == '__main__':
    ...
    target_relationships = sorted(util.read_classes('/data/caidaigang/project/3DSSG_Repo/data/3DSSG_Sub/relationships.txt'))
