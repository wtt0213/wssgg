...
class SSGDatasetGraph(data.Dataset):
    ...
    def data_preparation(self, points, instances, num_points, num_points_union, scene_id="",
        ...
        for i, instance_id in enumerate(nodes):
            ...
            obj_2d_feats[i] = np.load(f'/data/caidaigang/project/3DSSG_Repo/data/3RScan/{scene_id}/multi_view/instance_{instance_id}_class_{instance_name}_view_origin_vitb32_21k_mean.npy')
